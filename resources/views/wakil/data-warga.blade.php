<x-app-layout>
    ...
    <div class="mb-8">
        ...
        <p class="text-sm mt-1" style="color: #3F72AF;">Daftar seluruh warga — hanya bisa dilihat</p>
    </div>
                    ...
                    <tbody>
                        @foreach($wargas as $index => $warga)
                            <tr class="border-t" style="border-color: #DBE2EF;">
                                ...
                                <td class="px-6 py-4 font-medium" style="color: #112D4E;">{{ $warga->name }}</td>
                                <td class="px-6 py-4" style="color: #3F72AF;">{{ $warga->email }}</td>
                                <td class="px-6 py-4" style="color: #3F72AF;">{{ $warga->alamat ?? '-' }}</td>
                                <td class="px-6 py-4" style="color: #3F72AF;">{{ $warga->created_at->format('d M Y') }}</td>
                                <td class="px-6 py-4">
